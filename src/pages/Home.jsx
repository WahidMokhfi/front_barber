    ...
    <section className="apropos" id="apropos">
      ...
      <section className="avis" id="avis">
        ...
        <div className="box-container">
            ...
            <div className="box">
                <img src="img/icon-avis.png" alt="icon avis" className="quote" />
                <p>J'ai été agréablement surpris par l'excellent service et l'ambiance conviviale chez Barber Bègles. Le barbier a su
            ...
            <div className="box">
                <img src="img/icon-avis.png" alt="icon avis" className="quote" /> 
                <p> Un super salon ! Toujours impressionné par l'attention aux détails et le professionnalisme de
              l'équipe. Les produits utilisés sont de grande qualité et les résultats sont toujours impeccables. Je suis un
              client fidèle et je recommande vivement Barber Bègles.</p>
        ...
        <Link to="/avis" className="btn">Poster un avis</Link>
        </div>
    </section>
